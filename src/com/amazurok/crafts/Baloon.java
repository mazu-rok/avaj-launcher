    ...
    public void updateConditions() {
        ...
        switch (weather) {
            case "SUN":
                ...
                weatherTower.writeToFile(String.format("%s#%s(%d): Let's enjoy the good weather and take some pics.\n", this.getClass().getSimpleName(), this.name, this.id));
                break;
            case "RAIN":
                coordinates = new Coordinates(coordinates.getLongitude(), coordinates.getLatitude(), coordinates.getHeight() - 5);
                weatherTower.writeToFile(String.format("%s#%s(%d): Damn you rain! You messed up my baloon.\n", this.getClass().getSimpleName(), this.name, this.id));
                break;
            case "FOG":
            ...
            case "SNOW":
                ...
                weatherTower.writeToFile(String.format("%s#%s(%d): It's snowing. We're gonna crash.\n", this.getClass().getSimpleName(), this.name, this.id));
                break;
        }
