     ...
     public void updateConditions() {
        ...
        switch (weather) {
            case "SUN":
                ...
                weatherTower.writeToFile(String.format("%s#%s(%d): This is hot.", this.getClass().getName(), this.name, this.id));
                break;
            case "RAIN":
                coordinates = new Coordinates(coordinates.getLongitude() + 5, coordinates.getLatitude(), coordinates.getHeight());
                weatherTower.writeToFile(String.format("%s#%s(%d): It's raining. Better watch out for lightings.", this.getClass().getName(), this.name, this.id));
                break;
            case "FOG":
            ...
            case "SNOW":
                ...
                weatherTower.writeToFile(String.format("%s#%s(%d): My rotor is going to freeze!", this.getClass().getName(), this.name, this.id));
                break;
        }
